		...
		if ( is_plugin_active( 'meta-box/meta-box.php' ) ) {
			...
			add_action( 'admin_notices', function () {
                ...
                <div class="update-nag notice is-dismissible">
                    <p>
                        <strong><?php esc_html_e( 'Meta Box plugin has been deactivated!', ERE_TEXT_DOMAIN ); ?></strong>
                    </p>
                    <p><?php esc_html_e( 'As similar functionality is already embedded with in Easy Real Estate plugin.', ERE_TEXT_DOMAIN ); ?></p>
                    <p>
                        <em><?php esc_html_e( 'So, You should completely remove it from your plugins.', ERE_TEXT_DOMAIN ); ?></em>
                    </p>
                </div>
				<?php
			} );
