...
if ( ! function_exists( 'inspiry_booking_dates_search' ) ) :
	...
	function inspiry_booking_dates_search( $search_args ) {
		...
		$geolocation_radius = empty( $_GET['geolocation-radius'] ) ? '' : esc_html( $_GET['geolocation-radius'] );
		...
		if ( ! empty( $check_in ) || ! empty( $check_out ) ) {
			...
			$search_args['check-in']           = $check_in;
			$search_args['check-out']          = $check_out;
			$search_args['geolocation-radius'] = $geolocation_radius;
		}
