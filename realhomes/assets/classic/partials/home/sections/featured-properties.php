                                            ...
                                            <div class="span5 rh_slide__details">
                                                ...
                                                <div class="rh_prop_details clearfix">
                                                    ...
                                                    <div class="rh_prop_details__buttons">
                                                        <a href="<?php the_permalink() ?>"><?php esc_html_e( 'More Details', RH_TEXT_DOMAIN ); ?></a>
														<?php
														$images_count = inspiry_get_number_of_photos( get_the_id() );
														$images_count = ( ! empty( $images_count ) ) ? intval( $images_count ) : false;
														$images_str   = ( 1 < $images_count ) ? esc_html__( 'Photos', RH_TEXT_DOMAIN ) : esc_html__( 'Photo', RH_TEXT_DOMAIN );
														?>
													...
													<?php if ( ! empty( $prop_bedrooms ) ) : ?>
                                                        <div class="rh_prop_meta__single">
                                                            ...
                                                            <p class="details">
                                                                ...
                                                                <span><?php ( $prop_bedrooms > 1 ) ? esc_html_e( 'Bedrooms', RH_TEXT_DOMAIN ) : esc_html_e( 'Bedroom', RH_TEXT_DOMAIN ); ?></span>
                                                            </p>
                                                        </div>
													<?php endif; ?>
													...
													<?php if ( ! empty( $prop_bathrooms ) ) : ?>
                                                        <div class="rh_prop_meta__single">
                                                            ...
                                                            <p class="details">
                                                                ...
                                                                <span><?php ( $prop_bathrooms > 1 ) ? esc_html_e( 'Bathrooms', RH_TEXT_DOMAIN ) : esc_html_e( 'Bathroom', RH_TEXT_DOMAIN ); ?></span>
                                                            </p>
                                                        </div>
													<?php endif; ?>
                                                </div>
										...
										while ( $featured_properties_query->have_posts() ) :
                                            ...
                                            <li>
                                                ...
                                                <p><?php
													...
													$button_label = get_option( 'inspiry_string_know_more', esc_html__( 'Know More', RH_TEXT_DOMAIN ) );
													?>
