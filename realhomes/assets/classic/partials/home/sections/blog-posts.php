                        ...
                        if ($recent_posts_query->have_posts()) {
                            while ($recent_posts_query->have_posts()) {
                                ...
                                <article class="span4 clearfix">
                                    ...
                                    <div class="post-meta">
                                        <span><?php esc_html_e('On', RH_TEXT_DOMAIN ); ?> <span class="date"> <?php the_time(get_option('date_format')); ?></span></span>
                                        <span><?php esc_html_e('by', RH_TEXT_DOMAIN ); ?> <span class="author-link"><?php the_author() ?></span></span>
                                    </div>
                                    <p><?php framework_excerpt(12); ?></p>
                                    <a class="more-details" href="<?php the_permalink() ?>"><?php esc_html_e('Read More ', RH_TEXT_DOMAIN ); ?><i class="fas fa-caret-right"></i></a>
                                </article>
                                <?php
                            ...
                            ?>
                            <div class="span12">
                                <p class="nothing-found"><?php esc_html_e('No Posts Found!', RH_TEXT_DOMAIN ); ?></p>
                            </div>
                            <?php
