                                                ...
                                                <div class="rh_slide__prop_meta rvr_guest_capacity">
                                                    <span class="rh_meta_titles">
                                                        ...
                                                        if ( ! empty( $inspiry_rvr_guests_field_label ) ) {
	                                                        ...
	                                                        esc_html_e( 'Capacity', RH_TEXT_DOMAIN );
                                                        }
                                                        ?>
                                                    </span>
                                                    <div>
                                                ...
                                                <div class="rh_slide__prop_meta rvr_min_stay">
                                                    <span class="rh_meta_titles">
                                                        ...
                                                        if ( ! empty( $inspiry_rvr_min_stay_label ) ) {
	                                                        ...
	                                                        esc_html_e( 'Min Stay', RH_TEXT_DOMAIN );
                                                        }
                                                        ?>
                                                    </span>
                                                    <div>
                                                ...
                                                <div class="rh_slide__prop_meta">
                                                    <span class="rh_meta_titles">
                                                        ...
                                                        if ( ! empty( $bedrooms_label ) ) {
	                                                        ...
	                                                        esc_html_e( 'Bedrooms', RH_TEXT_DOMAIN );
                                                        }
                                                        ?>
                                                    </span>
                                                    <div>
                                                ...
                                                <div class="rh_slide__prop_meta">
                                                    <span class="rh_meta_titles">
                                                        ...
                                                        if ( ! empty( $bathrooms_label ) ) {
	                                                        ...
	                                                        esc_html_e( 'Bathrooms', RH_TEXT_DOMAIN );
                                                        }
                                                        ?>
                                                    </span>
                                                    <div>
                                            ...
                                            <div class="rh_slide__prop_meta">
                                                    <span class="rh_meta_titles">
                                                        ...
                                                        if ( ! empty( $area_label ) ) {
	                                                        ...
	                                                        esc_html_e( 'Area', RH_TEXT_DOMAIN );
                                                        }
                                                        ?>
                                                    </span>
                                                <div>
...
<?php
	...
	$slider_image_url = 'https://fakeimg.pl/2000x800&text=' . rawurlencode( esc_html__( 'No property is assigned to homepage slider!', RH_TEXT_DOMAIN ) );
	?>
    <!-- Slider Placeholder -->
