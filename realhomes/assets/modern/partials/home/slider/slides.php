...
if ( $slides_query->have_posts() ) : 
	...
	$slides_button_text = esc_html__( 'Read More', RH_TEXT_DOMAIN );
...
?>
	...
	$slider_image_url = 'https://fakeimg.pl/2000x800&text=' . rawurlencode( esc_html__( 'No custom slide is available to display!', RH_TEXT_DOMAIN ) );
	?>
	<!-- Slider Placeholder -->
