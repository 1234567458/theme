...
?>
<div class="rhea-search-popup-wrapper <?php echo 'yes' === $settings['hide_collapsed_labels'] ? esc_attr( 'rhea-hide-search-labels' ) : ''; ?>" id="rhea-popup-<?php echo esc_attr( $the_widget_id ); ?>">
