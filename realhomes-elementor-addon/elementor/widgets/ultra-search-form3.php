...
class RHEA_ultra_Search_Form_2_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'RH: Search Form 2', RHEA_TEXT_DOMAIN );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Search Form Inner Padding', RHEA_TEXT_DOMAIN ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Dropdown Background Hover/Active Color', RHEA_TEXT_DOMAIN ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Form Inner Border Radius', RHEA_TEXT_DOMAIN ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Advance Search Button Border Radius', RHEA_TEXT_DOMAIN ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Search Button Border Radius', RHEA_TEXT_DOMAIN ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
