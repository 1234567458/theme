        ...
        <div class="rhea_meta_wrapper_inner">
            ...
            <span class="figure">
                ...
                if ( ! empty( $property_bedrooms_label ) ) {
                    ...
                    echo '&nbsp;' . esc_html__( 'Bedrooms', RHEA_TEXT_DOMAIN );
                }
                ?>
            </span>
        </div>
        ...
        <div class="rhea_meta_wrapper_inner">
            ...
            <span class="figure">
                ...
                if ( ! empty( $property_bathroom_label ) ) {
                    ...
                    echo '&nbsp;' . esc_html__( 'Bathrooms', RHEA_TEXT_DOMAIN );
                }
                ?>
            </span>
        </div>
        ...
        <div class="rhea_meta_wrapper_inner">
            ...
            <span class="figure">
                ...
                if ( ! empty( $property_garage_label ) ) {
                    ...
                    echo '&nbsp;' . esc_html__( 'Garages', RHEA_TEXT_DOMAIN );
                }
                ?>
            </span>
        </div>
 ...
 */
rhea_property_widgets_additional_fields( get_the_ID(), 'listing', 'classic' );
